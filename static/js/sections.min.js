...
getCards(){tools.showLoading("data");tools.sreq('/control/list',function(status,response){if(status===200){var cards="";for(var i=0;i<response['own'].length;i++){var MAC=response['own'][i]['mac'];var name=response['own'][i]['name'];var update=this.templates.update;if(parseInt(response['own'][i]['version'])==this.version){update="";}
